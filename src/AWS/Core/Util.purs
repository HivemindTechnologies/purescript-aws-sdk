...
-- replace hard coded array with the describe-instance-type-offerings call
-- aws ec2 describe-instance-type-offerings --query "InstanceTypeOfferings[].InstanceType" --region eu-west-1
...
-- replace hard coded array with the describe-regions call
